...
int TLed::create()
{
    if( pthread_create(&this->threadId, NULL, exec_cmd, &this->cmdBuffer) )
    {
...
{
    static const float noteFreqs[128] = {8.18, 8.66, 9.18, 9.72, 10.30, 10.91, 11.56, 12.25, 12.98, 13.75,
